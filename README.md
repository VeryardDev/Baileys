...
```
yarn add github:Veryard/Baileys
```

Then import your code using:
```ts
import makeWASocket from '@veryard/baileys'
```
...
```ts
import makeWASocket, { useMultiFileAuthState } from '@veryard/baileys'
...
```ts
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from '@veryard/baileys'
...
```ts
import makeWASocket, { makeInMemoryStore } from '@veryard/baileys'
...
#### Forward Messages
- You need to have message object
```ts
...
#### Reaction Message
- You need to pass the key of message
```ts
await sock.sendMessage(
    jid,
    {
...
await sock.sendMessage(
    jid,
    {
        text: 'Hi, this was sent using https://github.com/Veryard/Baileys'
    }
)
```
...
import { downloadMediaMessage, getContentType } from '@veryard/baileys'
...
- ``` presence ``` can be one of the values in the WAPresence type alias
