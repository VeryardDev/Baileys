...
const baileysVersion = [2, 3000, 1043435811]
import type {
	BaileysEventEmitter,
	BaileysEventMap,
	ConnectionState,
...
export const generateMessageIDV2 = (userId?: string): string => {
	...
	return 'EMI' + hash.toString('hex').toUpperCase().substring(0, 18)
}

// generate a random ID to attach to a message
export const generateMessageID = () => 'EMI' + randomBytes(18).toString('hex').toUpperCase()
